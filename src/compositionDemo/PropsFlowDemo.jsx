...
export default function PropsFlowDemo() {
  ...
  console.log(
    "PROPS FLOW: parent rendering with theme =",
  ...
  return (
    <div className="demo-subsection">
      ...
      <p className="demo-note">
        The parent owns the theme state. It passes it down as a prop. Toggle the
        theme and watch the console — every level re-renders with the new value.
      </p>
      ...
      >
        <ThemedCard theme={theme} title="Themed Card">
          <p>
            This text color comes from the theme prop, which started at the TOP.
          </p>
      ...
      <p className="demo-note">
        ...
        Children can NOT change the parent's state directly. If a child needs to
        communicate up, it uses a callback function (next section!).
      </p>
    </div>
  );
}
