...
export default function RefVsState() {
  ...
  console.log(
    "REF VS STATE: rendering. stateCount =",
    stateCount,
    ", refCount.current =",
    refCount.current,
  );
  ...
  function handleStateClick() {
    ...
    console.log(
      "REF VS STATE: state changing (will re-render, and refCount will increment by 1)",
    );
  }
  ...
  return (
    <div className="demo-subsection">
      ...
      <p className="demo-note">
        Click "Change Ref" — the console updates but the screen does NOT. Click
        "Change State" — the screen updates AND the ref render count goes up.
      </p>
      <p>
        State count (on screen): <strong>{stateCount}</strong>
      </p>
      <p>
        Ref count (on screen): <strong>{refCount.current}</strong>
      </p>
      <p className="demo-note">
