...
export default function StaleStateTrap() {
  ...
  function addThreeDirect() {
    ...
    setCount(count + 1);
    console.log(
      "STALE STATE: called setCount(count+1) three times. count was",
      count,
    );
  }
  ...
  function addThreeUpdater() {
    ...
    setCount((count) => count + 1); // count=1 → 2
    setCount((count) => count + 1); // count=2 → 3
  ...
  return (
    <div className="demo-subsection">
      ...
      <p className="demo-note">
        Click each button and compare. The first only adds 1 (stale closure).
        The second adds 3 (updater function).
      </p>
      <p>
